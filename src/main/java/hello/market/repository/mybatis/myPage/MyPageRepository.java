...
public interface MyPageRepository {
    ...
    Integer select_lengthShopQna(int user_id, int artist_id, int answerCheck_start, int answerCheck_end);
    ...
    List<ShopQna> select_shopQna(int user_id, int artist_id, int page_limit, int answerCheck_start, int answerCheck_end);
