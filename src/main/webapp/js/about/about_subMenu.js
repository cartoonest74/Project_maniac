...
$(function(){
    const AboutSubMenu_content = $("#aboutSubMenuContent");
    ...
    const about_subMenu_page = (data, review_limit)=>{
        ...
        AboutSubMenu_content.html(tag_data);
        // page 번호 처리
        ...
        const pageCount_num = $("#aboutSubMenu_pageCount_num")
        const arr_page = [];
    ...
    const first_view = (review_limit=0, onOff="on") => {
    		...
    		$.ajax({
    			...
    			success: function(data, textStatus) {
                    about_subMenu_page(data,review_limit)
    			}
    		});
    		return;
    	}
