            ...
            <dl class="rootContentBox">
                <div class="managementBox">
                    ...
                    <dd class="managementContainer">
                        <a href="1"><i class="fa-solid fa-circle-question fa-lg" aria-hidden="true"></i>상품문의</a>
                        <a href="2"><i class="fa-solid fa-pen-to-square fa-lg" aria-hidden="true"></i>상품후기</a>
                    </dd>
                </div>
            </dl>
