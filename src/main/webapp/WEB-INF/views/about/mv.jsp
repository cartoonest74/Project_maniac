	...
	<c:import url="../basic/header.jsp">
	    ...
	    <div class="aboutInfo_menuBox">
            <nav class="aboutInfo_menu">
                ...
                <a style="color:lime;" href="${resolve_mv}">mv</a>
        ...
        <div class="discography_Box">
            ...
            <c:forEach var="mv" items="${mvList}">
                <c:set var="mv_name" value="${mv.mvName}"/>
                <c:set var="mv_href" value="${mv.mvHref}"/>
                <c:set var="mv_date" value="${mv.mvDate}"/>
                <a class="mv_content" href="${mv_href}" target="_blank">
                    <p class="mv_info">${mv_name}</p>
                    <p class="mv_info">${mv_date}</p>
                </a>
            </c:forEach>
            </div>
        </div>
